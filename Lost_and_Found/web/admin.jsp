...
<html lang="en">
    <head>
        ...
        <link href="manage-job/css/styles.css" rel="stylesheet" />
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a href="admin.jsp">
                <img class="img-fluid fpt-uni-logo" src="manage-job/assets/img/logo-fpt-certificate.png" style="width: 80%;" alt="Theme-Logo" />
            </a>
            <!-- Sidebar Toggle-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="article/manager-report.jsp">
                                <div class="sb-nav-link-icon"><i class="far fa-file-alt"></i></div>
                                Manager Report
                            </a>
                            <a class="nav-link" href="article/manager-band.jsp">
                            ...
                            <a class="nav-link" href="users/manage-report.jsp">
                                <div class="sb-nav-link-icon"><i class="far fa-file-alt"></i></div>
                                Manager Report
                            </a>
                            <a class="nav-link" href="users/manage-band.jsp">
                                <div class="sb-nav-link-icon"><i class="far fa-newspaper"></i></div>
                                Manage Band
                            </a>
                        </div>
