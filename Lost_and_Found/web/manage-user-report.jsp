                            ...
                            <div class="card-body"><div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="student" role="tabpanel"
                                        ...
                                        <table id="datatablesSimple">
                                            ...
                                            <tbody>
                                                <c:forEach var="member" items="${GET_LIST_REPORT_MEMBER}" varStatus="counter">
                                                    <tr>   
                                                        <td>${member.email}</td>      
                                                        <td>${member.articleContent}</td>
                                                        <td>${member.reportContent}</td>
                                                        <td>${member.fullName}</td>
                                                        <td><a href="DeleteCommandReportMemberController?reportID=${counter.count}" style="color: red;"> <i class="fa fa-trash" aria-hidden="true"></i> Delete</a></td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
