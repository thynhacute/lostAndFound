 ...
 * @author LEGION'
 */
@WebServlet(name = "SetStatusLikeController", urlPatterns = {"/SetStatusLikeController"})
public class SetStatusLikeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check = dao.setStatusLikeArticle(articleID, member.getId());
            if (check){
                 url = SUCCESS;
            }
        } catch (Exception e) {
