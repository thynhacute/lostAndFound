 ...
 * @author LEGION'
 */
@WebServlet(name = "LikeActionController", urlPatterns = {"/LikeActionController"})
public class LikeActionController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<LikeDTO> listLike = dao.getListLike(articleID1);
            request.setAttribute("GET_LIST_LIKE", listLike);
            url = SUCCESS;
        } catch (Exception e) {
        } finally {
