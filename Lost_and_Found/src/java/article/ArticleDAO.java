        ...
        try {
            ...
            if (conn != null) {
                String sql = "SELECT A.ArticleID,  A.ArticleContent, A.ImgURL, A.PostTime, A.LocationID, \n"
                        ...
                        + "			A.LocationID = L.LocationID AND A.ArticleTypeID = ? ";
